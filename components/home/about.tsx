export default function About() {
  return (
    <section id="about" className="bg-lighter">
      <div className="container mx-auto px-10 py-16 text-center">
        <div className="inline-block p-4 rounded-full bg-lighter">
          <svg
            className="dark w-10 h-10 align-[-0.125em] fill-primary"
        ...
        <h2 className="text-5xl text-primary font-light mt-6 mb-8">
        ...
        <p className="text-xl leading-relaxed">
          ...
          meditation exercises, group therapy and mental health progress
          tracking for holistic emotional well-being.
        </p>
      </div>
    </section>
  );
